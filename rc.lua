...
local mytextclock = awful.widget.textclock(markup("#7788af", "%a %d %b ") .. markup("#de5e1e", "%H:%M"))
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "#121", function () awful.util.spawn_with_shell("amixer -q set Master toggle") volume.update() end),
    awful.key({}, "#122", function () awful.util.spawn_with_shell("amixer -q -c 0 sset Master,0 4%-") volume.update() end),
    awful.key({}, "#123", function () awful.util.spawn_with_shell("amixer -q -c 0 sset Master,0 4%+") volume.update() end),
    ...
    -- Start a few progs
    awful.key({ modkey }, "è", function () start_ping() end)
)
